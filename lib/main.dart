  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListPage([
          ...
          PageInfo("BasicAppBarSample", (ctx) => BasicAppBarSample(), false),
          PageInfo("TabbedAppBarSample", (ctx) => TabbedAppBarSample(), false),
          PageInfo("DismissibleSample", (ctx) => DismissibleSample(), false),
          PageInfo("TodosSample", (ctx) => TodosSample(), false),
          PageInfo("HttpSample", (ctx) => HttpSample(), false),
          PageInfo("WebSocketSample", (ctx) => WebSocketSample(), false),
        ]));
  }
}
